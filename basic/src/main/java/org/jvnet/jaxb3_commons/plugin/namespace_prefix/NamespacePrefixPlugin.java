package org.jvnet.jaxb3_commons.plugin.namespace_prefix;
...
public class NamespacePrefixPlugin extends Plugin {
	...
	private static final String NAMESPACE_URI = "http://jaxb3-commons.dev.java.net/basic/namespace-prefix";
