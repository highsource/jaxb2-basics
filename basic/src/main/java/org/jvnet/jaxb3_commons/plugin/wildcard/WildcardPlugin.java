...
public class WildcardPlugin extends AbstractParameterizablePlugin {
	...
	public Collection<QName> getCustomizationElementNames() {
		return Arrays
				.asList(org.jvnet.jaxb3_commons.plugin.wildcard.Customizations.LAX_ELEMENT_NAME,
						org.jvnet.jaxb3_commons.plugin.wildcard.Customizations.SKIP_ELEMENT_NAME,
						org.jvnet.jaxb3_commons.plugin.wildcard.Customizations.STRICT_ELEMENT_NAME);
	}
