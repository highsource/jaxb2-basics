...
import org.jvnet.jaxb3_commons.tests.issues.IssueGH37Type;
...
public class GH37Test {
	...
	public void considersDefaultValuesInToString() {
		...
		Assert.assertEquals(
				"org.jvnet.jaxb3_commons.tests.issues.IssueGH37Type[testBoolean=true(default)]",
				a.append(null, new StringBuilder(), strategy).toString());
		IssueGH37Type b = new IssueGH37Type();
		b.setTestBoolean(true);
		Assert.assertEquals(
				"org.jvnet.jaxb3_commons.tests.issues.IssueGH37Type[testBoolean=true]",
